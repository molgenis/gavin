...
row <- data.frame(Tool = "OurTool", Data = "ClinVarNew", Total = 3356, TN = 1514, TP = 1202, FP = 96, FN = 227, VB = 58, VP = 259); df <- rbind(df, row)
...
row <- data.frame(Tool = "OurTool", Data = "MutationTaster2", Total = 1355, TN = 1184, TP = 106, FP = 1, FN = 23, VB = 9, VP = 32); df <- rbind(df, row)
...
row <- data.frame(Tool = "OurTool", Data = "UMCG_Onco", Total = 395, TN = 172, TP = 20, FP = 46, FN = 3, VB = 83, VP = 3); df <- rbind(df, row)
...
row <- data.frame(Tool = "OurTool", Data = "UMCG_Various", Total = 1512, TN = 1073, TP = 124, FP = 22, FN = 31, VB = 81, VP = 19); df <- rbind(df, row)
...
row <- data.frame(Tool = "OurTool", Data = "VariBenchTest", Total = 1887, TN = 833, TP = 303, FP = 175, FN = 85, VB = 369, VP = 122); df <- rbind(df, row)
...
row <- data.frame(Tool = "OurTool", Data = "VariBenchTraining", Total = 17490, TN = 6954, TP = 4273, FP = 1330, FN = 725, VB = 3063, VP = 1145); df <- rbind(df, row)
